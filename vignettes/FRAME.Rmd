...
FRAME is a fishery risk assessment tool that links a streamlined user interface to an advanced operating model, using management strategy evaluation to identify sustainable fishery management procedures (MPs).
...
# Step C2: Run an Application (single MP) (MSE stream)
...
# Step D: Ancillary indicators (MSE stream)
