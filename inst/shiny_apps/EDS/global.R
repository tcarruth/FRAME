...
F_list<<-list("Not variable (CV ~ 10%)" = "F_10", "Variable (10% < CV < 30%)" = "F_10_25",
...
PRM_mins<- c(  0,     0.05,    0.25,      0.5,      0.75,  95)
PRM_maxes<-c(  0.05,  0.25,     0.5,      0.75,      0.95, 100)
...
A_list<<-list("None"="A_1","Small (A<5%)"="A_1_5", "Small-moderate (5% < A < 10%)" = "A_5_10", "Moderate (10% < A < 20%)" = "A_10_20",
              "Large (20% < 30%)"="A_20_30","Very large (30% < A < 40%)" = "A_30_40", "Huge (40% < A < 50%)"="A_40_50")

A_mins<- c(0.01,  0.01,     0.05,    0.1,        0.2,       0.3,       0.4)
...
IV_mins<-c(0.01,0.01,0.05,0.1,0.2)
