...
redoEval<-function(fease=F){
  ...
  withProgress(message = "Calculating Evaluation results", value = 0, {
    ...
    updateSelectInput(session,"Advice_MP1",choices=Ptab2$MP,selected=Ptab2$MP[1])
    updateSelectInput(session,"Advice_MP2",choices=Ptab2$MP,selected=Ptab2$MP[2])
    updateSelectInput(session,"Advice_MP3",choices=Ptab2$MP,selected=Ptab2$MP[3])
