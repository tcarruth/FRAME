...
```{r Ptab,echo=F,warning=F,error=F,message=F}
 ...
 MSEobj_app<-Sub(params$MSEobj_app,MPs=params$MSEobj_app@MPs[2])
 MSEobj_reb_app<-Sub(params$MSEobj_reb_app,MPs=params$MSEobj_reb_app@MPs[2])
...
CCU_plot(VOIout[[1]],MSEobj_app,MPcols=params$MPcols[2],maxrow=1,maxcol=1)
