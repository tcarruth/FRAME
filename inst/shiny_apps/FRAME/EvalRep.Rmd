...
```{r Ptab,echo=F,warning=F,error=F,message=F}
 ...
 MSEobj_top<-Sub(params$MSEobj,MPs=Ptab2$MP)
 MSEobj_reb_top<-Sub(params$MSEobj_reb,MPs=Ptab2$MP)
...
```{r P1_LTY,echo=F,warning=F,error=F,message=F,fig.width=10, fig.height=10}
P1_LTY_plot(params$MSEobj_top,MPcols=params$MPcols,burnin=params$burnin)

```

Long term yield (LTY) vs probability biomass is greater than half BMSY in years 11-50 (PI.1.2.1a)

```{r P2_LTY,echo=F,warning=F,error=F,message=F,fig.width=10, fig.height=10}
P2_LTY_plot(params$MSEobj_top,MPcols=params$MPcols)

```

Long term yield (LTY) vs probability biomass is greater than half BMSY in years 11-50 (PI.1.2.1a)

```{r P3_LTY,echo=F,warning=F,error=F,message=F,fig.width=10, fig.height=10}
P3_LTY_plot(params$MSEobj_top,MSEobj_reb_top,MPcols=params$MPcols)
