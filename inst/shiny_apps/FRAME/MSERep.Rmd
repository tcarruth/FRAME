...
P1_LTY_plot(MSEobj_top,MPcols=params$MPcols,burnin=params$burnin)
...
P2_LTY_plot(MSEobj_top,MPcols=params$MPcols)
...
P3_LTY_plot(MSEobj_top,MSEobj_reb_top,MPcols=params$MPcols)
