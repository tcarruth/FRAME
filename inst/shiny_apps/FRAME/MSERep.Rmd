...
This table includes probability scores relating to a number of MSC performance indicators. For example, PI111a (P.I.1.1.1) relates to the 'Stock status' component of the standard and the first interpretation (a) relates to the likelihood that in the first 10 years of the MSE projection, biomass is below half of BMSY. 
